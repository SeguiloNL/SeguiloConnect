...
if ($page === 'order_edit') {
    ...
    // plans visible to reseller (for nu: alle plannen)
    $plans = $pdo->query("SELECT * FROM plans ORDER BY name ASC")->fetchAll();
    // sims assigned to current user or their subtree
    $me = current_user()['id'];
    ...
    // end customers in subtree (role end_customer)
